...
export class CoursesComponent implements OnInit {
  private coursesList: ICourse[] = [
    ...
    },
    {
      ...
      duration: 360,
      description:
        "This training is a Scrum simulation, where participants create a product in groups and learn Scrum in a practical way. \
       Along the way, we discuss core Scrum rules and how they help overcome typical challenges.",
    },
  ];
  ...
  public copyLink(id: number): void {
